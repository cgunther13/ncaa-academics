...
```{r}
ggmap(map) + # loads map
  geom_segment(aes(x = avg_long, xend = (avg_long + long_dir_avg), y = avg_lat, yend = (avg_lat + lat_dir_avg), color = count), data = grouped, arrow = arrow(length=unit(0.15,"cm"), ends="first", type = "closed")) + # adds direction vectors
